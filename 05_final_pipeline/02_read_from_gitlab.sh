...
do 
  ...
  then
    ...
    curl --silent --request GET --header "PRIVATE-TOKEN: $gitlab_token" "https://git.nfdi4plants.org/api/v4/projects/$arc_id/repository/files/isa%2Einvestigation%2Exlsx/raw?ref=main" -o .tmp02_investigations/$arc_id'_isa.inv.xlsx'
